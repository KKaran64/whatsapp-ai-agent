...
```
***REMOVED-MONGO-URI***@cluster0.rwk3t5o.mongodb.net/whatsapp-sales?retryWrites=true&w=majority
```
...
Should look like:
```
***REMOVED-MONGO-URI***@cluster0.rwk3t5o.mongodb.net/?retryWrites=true&w=majority
```
...
```env
MONGODB_URI=***REMOVED-MONGO-URI***@cluster0.rwk3t5o.mongodb.net/whatsapp-sales?retryWrites=true&w=majority
```
...
const uri = '***REMOVED-MONGO-URI***@cluster0.rwk3t5o.mongodb.net/whatsapp-sales?retryWrites=true&w=majority';
